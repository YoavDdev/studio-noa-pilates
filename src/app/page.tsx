    ...
    <main className="min-h-screen bg-[#FDFCFA] text-[#2A2520]">
      ...
      <section className="relative min-h-screen grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-8 md:px-16 lg:px-24 py-24 md:py-0 order-2 md:order-1">
          ...
          <h1 className="font-heading text-[clamp(4rem,8vw,7rem)] font-light leading-[0.95] text-[#1A1410] mb-8 fade-in-up" style={{ animationDelay: '0.1s' }}>
            נועה<br />גורלניק
          </h1>
          ...
          {!user ? (
            <div className="flex flex-wrap gap-4 fade-in-up" style={{ animationDelay: '0.35s' }}>
              ...
              <Link href="/videos"
                className="inline-flex items-center gap-3 border border-[#EBE5DC] text-[#2A2520] font-body text-sm tracking-wider px-8 py-4 hover:border-[#C9A871] hover:text-[#C9A871] transition-colors duration-300">
                לספריית השיעורים
              </Link>
            </div>
          ) : (
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-[#A39888] opacity-60">
      ...
      <section className="section-padding reveal-on-scroll border-t border-[#EBE5DC]">
        <div className="max-w-3xl mx-auto px-6 md:px-12 text-center">
          ...
          <h2 className="font-heading text-[clamp(2.5rem,5vw,4rem)] font-light text-[#1A1410] mb-10 fade-in-up" style={{ animationDelay: '0.1s' }}>
            נעים להכיר
          </h2>
      ...
      <section className="section-padding reveal-on-scroll bg-[#F5EFE6]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-px bg-[#EBE5DC]">
            {[
              ...
              <Link
                key={item.title}
                href={item.href}
                className="group block bg-[#FDFCFA] p-10 md:p-14 hover:bg-[#F5EFE6] transition-colors duration-500 fade-in-up"
      ...
      ═══════════════════════════════════════ */}
      <section className="py-28 md:py-40 bg-[#1A1410] reveal-on-scroll">
        <div className="max-w-3xl mx-auto px-6 md:px-12 text-center">
          <p className="font-heading text-[clamp(1.75rem,4vw,3rem)] font-light text-[#F5EFE6] leading-[1.7] fade-in-up">
      ...
      <section className="section-padding reveal-on-scroll">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Package */}
            <div className="border border-[#EBE5DC] p-10 fade-in-up" style={{ animationDelay: '0.2s' }}>
              <p className="font-body text-xs tracking-widest uppercase text-[#A39888] mb-6">חבילה</p>
              <div className="font-heading text-6xl font-light text-[#1A1410] mb-1">₪200</div>
            ...
            {/* Monthly */}
            <div className="bg-[#1A1410] p-10 fade-in-up" style={{ animationDelay: '0.3s' }}>
              <p className="font-body text-xs tracking-widest uppercase text-[#A39888] mb-6">מנוי חודשי</p>
              <div className="font-heading text-6xl font-light text-[#F5EFE6] mb-1">₪99</div>
